...
public class Application : ConsolePresentation
{
    ...
    public Application()
    {
        ...
        Button Exit = new Button(55, 15, 8, 5, "EXIT", new BorderStyle(Line.SingleDouble));
        ...
        Button btnPlus = new Button(16, 20, 8, 5, "PLUS", new BorderStyle(Line.Double));
        ...
        Button btnMinus = new Button(25, 20, 9, 5, "MINUS", new BorderStyle(Line.DoubleSingle));
        ...
        textBox.BorderStyle = new BorderStyle(Line.SingleRound);
