...
namespace BCPF.Core.Controls
{
    public class Button : Control
    {
        ...
        public Button(int X, int Y, int Width, int Height, string Content, BorderStyle borderStyle)
        {
            this.X = X;
            this.Y = Y;
            this.Width = Width;
        ...
        public Button(int X, int Y, int Width, int Height, string Content, BorderStyle borderStyle, VerticalAlignment ContentVerticalAlignment)
        {
            this.X = X;
            this.Y = Y;
            this.Width = Width;
        ...
        public Button(int X, int Y, int Width, int Height, string Content, BorderStyle borderStyle, HorizontalAlignment ContentHorizontalAlignment)
        {
            this.X = X;
            this.Y = Y;
            this.Width = Width;
        ...
        public Button(int X, int Y, int Width, int Height, string Content, BorderStyle borderStyle, HorizontalAlignment ContentHorizontalAlignment, VerticalAlignment ContentVerticalAlignment)
        {
            this.X = X;
            this.Y = Y;
            this.Width = Width;
        ...
        public Button(int X, int Y, int Width, int Height, string Content, Thickness Padding, BorderStyle borderStyle)
        {
            this.X = X;
            this.Y = Y;
            this.Width = Width;
        ...
        public Button(int X, int Y, int Width, int Height, string Content, Thickness Padding, BorderStyle borderStyle, VerticalAlignment ContentVerticalAlignment)
        {
            this.X = X;
            this.Y = Y;
            this.Width = Width;
        ...
        public Button(int X, int Y, int Width, int Height, string Content, Thickness Padding, BorderStyle borderStyle, HorizontalAlignment ContentHorizontalAlignment)
        {
            this.X = X;
            this.Y = Y;
            this.Width = Width;
        ...
        public Button(int X, int Y, int Width, int Height, string Content, Thickness Padding, BorderStyle borderStyle, HorizontalAlignment ContentHorizontalAlignment, VerticalAlignment ContentVerticalAlignment)
        {
            this.X = X;
            this.Y = Y;
            this.Width = Width;
